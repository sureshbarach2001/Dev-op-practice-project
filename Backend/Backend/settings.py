...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aviato.fyp@gmail.com'
EMAIL_HOST_PASSWORD = 'zsxi nywn vmjd cafg'
DEFAULT_FROM_EMAIL = 'Aviato Support aviato.fyp@gmail.com'

# Frontend URL for password reset
FRONTEND_URL = 'aviato://reset-password' 
...
BASE_URL = 'http://127.0.0.1:8000/'  # Change port if you're using a different one
